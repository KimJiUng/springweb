...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http //   http
                ...
                .antMatchers("/member/message").hasRole("MEMBER")
                ...
                .ignoringAntMatchers("/board/save") // 글 작성
                .ignoringAntMatchers("/room/write") // 방 등록
                .ignoringAntMatchers("/room/roomlist")  // 지도에 표시할 데이터 요청/응답
                .ignoringAntMatchers("/room/myroomlist")    // 내가 등록한 방
                .ignoringAntMatchers("/member/isread")  // 메세지 읽음처리 요청
                .ignoringAntMatchers("/member/msgdelete")   // 메세지 삭제처리 요청
                .and()
